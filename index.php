...
<body>
   <div class="homepage">
     <!-- <header>
        <div class="headimage">
            <img src="/shoppa-main/images/Frame 20.png" alt="headimage">
        </div>
     </header> -->
          ...
          <div class="Explored">
            <div class="versatile">
                ...
                <div class="versatileimg">
                    <div class="image">
                        <img src="/shoppa-main/images/Group 2.png" alt="jacket">
                    </div>
                    <div class="images">
                       <<img src="/shoppa-main/images/Frame 19.png" alt="dots">
                    </div>
                </div>
